...
###################################################################################################### 
    ...
    def load_model(self, model_name=None):
        if model_name is None:
            with open(f'{self.model_name}_words.pkl', 'rb') as file:
                self.words = pickle.load(file)
            with open(f'{self.model_name}_classes.pkl', 'rb') as file:
                self.classes = pickle.load(file)
            self.model = load_model(f'{self.model_name}.h5')
        else:
            with open(f'{model_name}_words.pkl', 'rb') as file:
                self.words = pickle.load(file)
            with open(f'{model_name}_classes.pkl', 'rb') as file:
                self.classes = pickle.load(file)
